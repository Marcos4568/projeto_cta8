...
export default function HomePage() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setTempDHT(22 + Math.random() * 3);
      setUmidade(50 + Math.random() * 10);
      setTempDS18B20(25 + Math.random() * 2);
      setPortaAberta(Math.random() > 0.5);
    }, 3000);
        ...
        <div className="bg-white shadow-lg rounded-2xl p-6 text-center">
          ...
          <p
            className={`text-3xl font-bold mt-2 ${
              portaAberta ? "text-green-600" : "text-red-600"
            }`}
          >
